...
define(function() {
  /**
   * Constructor
   * @class VariableLifetimeChartElement
   * @param {Object} options - options for create life time chart element
   * @returns {VariableLifetimeChartElement}
   */
  ...
  /**
   * Handle right click to chart
   * @memberOf VariableLifetimeChartElement
   */
  ...
  /**
   * Handle right click to chart name
   * @memberOf VariableLifetimeChartElement
   */
